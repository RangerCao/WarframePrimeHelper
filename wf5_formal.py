...
class WFPriceHelperApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Warframe 开核桃助手v3.0")
        self.geometry("700x550") # 缩小窗口高度
    ...
    def setup_ui(self):
        ...
        ctk.CTkLabel(self.header_frame, text="开核桃助手 V3.0", font=("微软雅黑", 24, "bold"), text_color=THEME["gold"]).pack(side="left")
